...
<html>
  <head>
    ...
    <title>PT Maju Jaya | Quotation</title>
  ...
  <body onload="window.print();">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">Date: {{$info[0]->quo_datetime}}</small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          <b>Quotation:</b><br>
          <b>Number:</b> {{$info[0]->quo_nomor}}<br>
        </div>
        <!-- /.col -->
      </div>
      <!-- /.row -->
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="{{url('/')}}/quotation/print/{{$info[0]->quo_id}}" target="_blank" class="btn btn-info pull-right"><i class="fa fa-print"></i> Print</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
